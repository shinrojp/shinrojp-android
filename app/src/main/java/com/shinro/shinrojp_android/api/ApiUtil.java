...
public class ApiUtil extends Constants {
    ...
    public static GrammarService getGrammarApiService(boolean isAuthorization, String token) {
        return RetrofitClient.getClient(BASE_URL_LEARN, isAuthorization, token).create(GrammarService.class);
    }
